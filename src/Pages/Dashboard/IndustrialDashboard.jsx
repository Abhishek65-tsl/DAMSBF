...
const IndustrialDashboard = () => {
  ...
  const parameters = [
    { title: "Wind Volume", amount: "33629.1 Nm³/hr", value: 33629.1, ucl: 35000, lcl: 30000 },
    { title: "HBT", amount: "5.5°C", value: 5.5, ucl: 5.0, lcl: -2.0 },
    { title: "PCI Rate(Tons/hr)", amount: "62.0", value: 62.0, ucl: 65.0, lcl: 50.0 },
    { title: "Hopper-1 Weight", amount: "45.0 T", value: 90.0, ucl: 70.0, lcl: 40.0 },
    { title: "LMG-1 Operating Time", amount: "2.5s", value: 2.5, ucl: 5.0, lcl: 3.0 },
    { title: "GB Casting Temperature", amount: "79.0°C", value: 79.0, ucl: 80.0, lcl: 30.0 },
    { title: "Chute Rotating Angle", amount: "201.0°", value: 201.0, ucl: 200.0, lcl: 100.0 },
    { title: "Hydraulic Pressure", amount: "180.0 Bar", value: 180.0, ucl: 220.0, lcl: 150.0 },
    { title: "Oil Tank Particle Counter", amount: "19.0 | 18.5 | 17.8", value: 18.4, ucl: 20.0, lcl: 5.0 },
    { title: "HBP", amount: "4.1 Bar", value: 4.1, ucl: 6.0, lcl: 4.5 },
    { title: "PCI Rate(Kg/THM)", amount: "205.0", value: 205.0, ucl: 220.0, lcl: 180.0 },
    { title: "Hopper-2 Weight", amount: "98.0 T", value: 10.0, ucl: 100.0, lcl: 40.0 },
    { title: "LMG-2 Operating Time", amount: "3.0s", value: 3.0, ucl: 5.0, lcl: 3.0 },
    { title: "GB Oil Temperature", amount: "28.0°C", value: 28.0, ucl: 60.0, lcl: 30.0 },
    { title: "Chute Tilting Angle", amount: "58.0°", value: 58.0, ucl: 60.0, lcl: 20.0 },
    { title: "Hydraulic Pump Status", amount: "PUMP - 1", value: 1, ucl: 2, lcl: 0 },
    { title: "Gearbox temperature", amount: "85.0°C", value: 85.0, ucl: 80.0, lcl: 30.0 }
  ];
      ...
      <div className="max-w-8xl px-2 mx-auto py-2">
        <div className="grid grid-cols-1 lg:grid-cols-8 gap-4">
          ...
          <div className="col-span-3 flex flex-col gap-2 relative">
            ...
            <div className="flex justify-around bg-white rounded-lg shadow-sm border p-4">
